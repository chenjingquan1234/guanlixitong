  ...
  <div id="jsd">
    ...
    <div style="display: flex; flex-direction: row; justify-content: space-between; margin: 0 5%; font-size: 1rem; color: #000000;">
      ...
      <table border="1" style="width: 100%; border-collapse: collapse; table-layout: fixed;">
		...
		<!--  -->
    <div  v-if="list.serviceItemList && list.serviceItemList.length? true : false">
    ...
    <!--  -->
    <div v-if="list.productItemList && list.productItemList.length? true : false">
    ...
    <!--  -->
    <div v-if="list.additionalList && list.additionalList.length? true : false">
    ...
    <!--  -->
    <div v-if="list.card_no || list.card_balance || list.integral">
      ...
      <div style="margin: 0 5%; display: flex; flex-direction: row; justify-content: flex-start; color: #000000;">
		...
		<!--  -->
    <div v-if="list.shengyuList && list.shengyuList.length > 0">
      ...
      <div style="margin: 0 5%; display: flex; flex-direction: row; justify-content: flex-start; color: #000000;">
        <table border="1" style="width: 100%; border-collapse: collapse; table-layout: fixed;">
          ...
          <tr style="text-align: center;" v-for="(item, index) in list.shengyuList" :key="index">
