...
import sgd1 from './../components/other/sgd1.vue'
import jsd from './../components/other/jsd.vue'
import cgd from './../components/other/cgd.vue'
...
import dianzhijiankangbaogao from "./../components/setUp/dianzhijiankangbaogao.vue"
...
import shopping_dingdanguanli from "./../components/Shopping/shopping_dingdanguanli.vue"
import shopping_shangpingguoli from "./../components/Shopping/shopping_shangpingguoli.vue"
...
export default new Router({
  ...
  routes: [
    ...
    {path: '/sgd1', name: "sgd1", component: sgd1, meta: {keepAlive: false}},
    {path: '/cgd', name: "cgd", component: cgd, meta: {keepAlive: false}},
    ...
    {path: '/dianzhijiankangbaogao', name: 'dianzhijiankangbaogao', component: dianzhijiankangbaogao, meta: {keepAlive: true}},
    ...
    // Shopping
    {path: '/shopping_dingdanguanli', name: "shopping_dingdanguanli", component: shopping_dingdanguanli, meta: {keepAlive: true}},
    {path: '/shopping_shangpingguoli', name: "shopping_shangpingguoli", component: shopping_shangpingguoli, meta: {keepAlive: true}}
  ]
})
