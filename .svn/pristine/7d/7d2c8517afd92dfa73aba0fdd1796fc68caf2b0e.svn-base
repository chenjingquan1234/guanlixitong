...
import BaseTime from '../../BaseComponets/BaseTime'
export default{
  name: "three",
  components:{
    mytable,
  ...
  methods:{
    ...
    search: function(){
      ...
      this.handlePageChange({search: this.key_name, sid: this.store_id, supplier_id: this.supplier_id, start_time, end_time});
    },
    download: function(){
