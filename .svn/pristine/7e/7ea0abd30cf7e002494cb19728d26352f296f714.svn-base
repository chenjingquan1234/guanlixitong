<template>
  <div id="three">
    ...
    <mytable :tableTitle="tableTitle" :tableData="tableData" :check_box="check_box" :operation_mod="operation_mod" :operation_del_name="operation_del_name" :operation_="operation_" :operation_name="operation_name"
    @resData="resData" @del="del" @operat="operat" @handlePageChange="handlePageChange" ref="mytable"></mytable>
...
export default{
  ...
  data(){
    return{
      ...
      tableTitle: [
        ...
        {key: "ename", title: "领料员", min_width: "100"},
        {key: "create_time", title: "领料时间", min_width: "100"},
  ...
  methods:{
    ...
    handlePageChange: function(data){
      ...
      this.$refs.mytable.findList(this.$store.state.domainName_http+"/StoreAdmin/Statistics/getPickingOrderList", data);
    }
  }
}
</script>
