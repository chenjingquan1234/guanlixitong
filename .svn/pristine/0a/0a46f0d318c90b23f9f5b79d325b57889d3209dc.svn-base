...
export default{
  ...
  data(){
    return{
      ...
      tableTitle: [
        ...
        {key: "name", title: "盘点人", min_width: "100"},
        ...
        {key: "difference", title: "相差数量", min_width: "100"},
        {key: "total_money", title: "相差金额", min_width: "100"},
  ...
  methods:{
    ...
    handlePageChange: function(data){
      ...
      this.$refs.mytable.findList(this.$api.yuming + "/StoreAdmin/Statistics/getCountOrderDetailList ", data);
    }
  }
}
</script>
