<template>
  <div>
    <div class="contation">
      <div class="query-box">
        <el-select v-model="status_value" clearable size="mini" placeholder="请选择">
          <el-option
        ...
        <el-button type="primary" size="mini" @click="handlePageChange" st yle="margin-left:10px">查询</el-button>
      </div>
      <BaseTable
        :check_box="false"
        :operation_mod="false"
