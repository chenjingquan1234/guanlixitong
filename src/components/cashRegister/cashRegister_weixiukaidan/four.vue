<template>
  <div id="four">
    ...
    <mytable :tableTitle="tableTitle" :tableData="tableData" :operation_="operation_" :operation_mod="operation_mod" :operation_del="operation_del" :operation_name="operation_name"
    @operat="operat" @resData="resData" @handlePageChange="handlePageChange" ref="mytable"></mytable>
...
export default{
  ...
  methods:{
    ...
    handlePageChange(data){
      ...
      this.$refs.mytable.findList(this.$store.state.domainName_http+"/storeadmin/order/getInvalidOrderList", data);
    }
  },
  mounted(){
