<template>
  <div id="two">
    <div class="pb-nav">
      ...
      <el-select size="small" v-model="people_name" clearable placeholder="报损人" @change="people_change">
    ...
    <el-input size="small" v-model="remark"><label slot="prepend">备注</label></el-input>
...
export default{
  ...
  methods:{
    ...
    enter(){
      ...
      this.$axios.post(this.$store.state.domainName_http+"/StoreAdmin/Statistics/confirmBreakageOrder",
