...
export default{
  ...
  methods:{
    search: function(){
      this.$api.HttpPost("/StoreAdmin/Statistics/allMoney", {sid: this.store_name, type: 3})
      .then((data)=>{
