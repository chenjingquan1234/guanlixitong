<template>
  <div id="two">
    <div class="pb-nav">
      ...
      <el-select size="small" v-model="supplier_name" filterable clearable placeholder="供应商" @change="supplier_change">
        <el-option v-for="value in supplier_select" :key="value.id" :label="value.supplier_name" :value="value.id"></el-option>
      </el-select>
      <el-select size="small" v-model="people_name" filterable clearable placeholder="操作人" @change="people_change">
